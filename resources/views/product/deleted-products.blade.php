            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row">
                          <div class="col-md-6">
                        <form class="d-flex" role="search" action="{{route('product.trashedITEMS')}}" method="GET">
                            @csrf 
                        ...
                        <button class="btn btn-outline-success" type="submit">Search</button>
                          ...
                          <div class="col-md-6">
                                    <a href="{{route('product.index')}}" class="float-end btn btn-success">View All Products</a>
                          </div>
                        </div>
